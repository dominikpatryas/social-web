...
class Message {
    ...
    public function getConvos() {
        ...
        $res .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
			...
			<span class='timestamp_smaller' id='grey'> " . $lastest_message_details[2] . "</span> 
    ...
    public function getConvosDropdown($data, $limit) {
        ...
        $res .= "<a href='messages.php?u=$username'>
        ...
        $res .= "<input type='hidden' class='nextPageDropDownData' value='" . ($page +1) . "'><input type='hidden' class='noMoreDropdownData' value='false'>";
        
        else
        
        $res .= "<input type='hidden' class='noMoreDropdownData' value='true'> <p style='text-align: center;'>No more messages to load!</p>";
